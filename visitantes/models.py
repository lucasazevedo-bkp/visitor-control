...
class Visitante(models.Model):
    ...
    horario_saida = models.DateTimeField(verbose_name='Horário de saída do condomínio', auto_now=False, blank=True, null=True)
    ...
    morador_responsavel = models.CharField(verbose_name='Nome do morador responsável por autorizar a entrada do visitante', max_length=194, blank=True)
    registrado_por = models.ForeignKey('porteiros.Porteiro', verbose_name='Porteiro responsável pelo registro', on_delete=PROTECT)
